...
open class Groups(
     ...
     */
    override fun where(condition: Condition?): Groups = Groups(qualifiedName, if (aliased()) this else null, condition)
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: Select<*>): Groups = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: Select<*>): Groups = where(DSL.notExists(select))
}
