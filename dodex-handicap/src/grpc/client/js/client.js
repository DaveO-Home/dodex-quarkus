...
import {
  ...
  HandicapData, Course, ListCoursesResponse
...
window.axios = axios;
//import "../static/service-worker.js";
import "./weather.js";
...
const submitRemoveScore = async (event) => {
  ...
  command.setKey(message.pin);
  command.setJson(scoreJson);
  if(!confirm("Remove latest score?")) {
    popupMessage("Remove last score cancelled", "alert-warning")
    return;
  }
