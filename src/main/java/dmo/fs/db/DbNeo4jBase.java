...
public abstract class DbNeo4jBase {
	...
	public Promise<Map<String, Integer>> processUserMessages(javax.websocket.Session ws, MessageUser messageUser)
			throws Exception {
	...
	public Promise<StringBuilder> buildUsersJson(javax.websocket.Session ws, MessageUser messageUser)
