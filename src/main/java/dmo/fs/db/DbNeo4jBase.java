...
public abstract class DbNeo4jBase {
    ...
    public Promise<Map<String, Integer>> processUserMessages(jakarta.websocket.Session ws, MessageUser messageUser)
            throws Exception {
        ...
        .onItem().invoke(record -> {
            ...
            ws.getAsyncRemote().sendText(fromUser + postDate.format(formatter) + " " + message);
    ...
    public Promise<MessageUser> deleteUser(jakarta.websocket.Session ws, MessageUser messageUser)
    ...
    public Promise<MessageUser> addMessage(jakarta.websocket.Session ws, MessageUser messageUser, String message,
    ...
    public Promise<MessageUser> selectUser(MessageUser messageUser, jakarta.websocket.Session ws)
    ...
    public Promise<StringBuilder> buildUsersJson(jakarta.websocket.Session ws, MessageUser messageUser)
