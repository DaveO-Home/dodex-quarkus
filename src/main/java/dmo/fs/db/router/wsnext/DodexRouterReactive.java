 ...
 */
@UnlessBuildProperty(name = "DEFAULT_DB", stringValue = "h2")
...
@UnlessBuildProperty(name = "DEFAULT_DB", stringValue = "mariadb")
@UnlessBuildProperty(name = "DEFAULT_DB", stringValue = "postgres")
