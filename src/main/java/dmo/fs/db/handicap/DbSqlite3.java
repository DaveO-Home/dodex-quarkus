...
public abstract class DbSqlite3 extends DbDefinitionBase implements HandicapDatabase {
    ...
    protected final static String CHECKGOLFERSQL = "SELECT name FROM sqlite_master WHERE type='table' AND name = 'GOLFER'";
    protected final static String CHECKCOURSESQL = "SELECT name FROM sqlite_master WHERE type='table' AND name = 'COURSE'";
    protected final static String CHECKSCORESSQL = "SELECT name FROM sqlite_master WHERE type='table' AND name = 'SCORES'";
    protected final static String CHECKRATINGSSQL = "SELECT name FROM sqlite_master WHERE type='table' AND name = 'RATINGS'";
