...
public abstract class DbFirebaseBase {
    ...
    public FirebaseUser updateUser(Session ws, FirebaseUser firebaseUser)
	...
	public Future<MessageUser> deleteUser(Session ws, MessageUser messageUser)
			throws InterruptedException, ExecutionException {
	...
	public Future<FirebaseMessage> addMessage(Session ws, MessageUser messageUser, String message,
	...
	public Future<FirebaseUser> selectUser(MessageUser messageUser, Session ws)
	...
	public Future<StringBuilder> buildUsersJson(Session ws, MessageUser messageUser)
	...
	public Future<Map<String, Integer>> processUserMessages(Session ws, FirebaseUser firebaseUser)
			throws Exception {
        ...
        if(DodexUtil.isNull(documents)) {
            promise.complete(counts);
                ...
                ws.getAsyncRemote().sendText(handle + formatDate.format(postDate) + " " + message.getString("message"));
